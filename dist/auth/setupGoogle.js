...
const SCOPES = [
    ...
    "https://www.googleapis.com/auth/contacts", // read contacts (People API)
];
...
async function main() {
    ...
    const auth = new google.auth.OAuth2(process.env.GOOGLE_CLIENT_ID, process.env.GOOGLE_CLIENT_SECRET, REDIRECT_URI);
